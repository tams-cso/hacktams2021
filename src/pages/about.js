        ...
        return (
            <div className="about" id="about">
                ...
                <div className="info">
                    <h1>About</h1>
                    <p>
                        hackTAMS is an annual hackathon organized by students at the Texas Academy of Mathematsics and
                        Science. Our event brings high school students from across the state of Texas to showcase their
                        talent and creativity. A hackathon is a coding marathon where students design, build, and
                        present a project — typically software, and sometimes hardware — within a short period of time.
                        Students will have access to mentors, speakers, workshops, and networking opportunities while
                        working on their project. Due to COVID-19, this year’s hackTAMS will be held <b>virtually</b>.
                        <br />
                        <br />
                    ...
                    <div className="tracks-container">
                        ...
                        <div className={`track hack ${this.state.toggle}`}>
                            <p>
                                ...
                                engineering. Students will design and prototype a project using their technical skills
                        ...
                        <div className={`track design ${this.state.toggle}`}>
                            <p>
                                The Prototype track is for participants who have little to no coding experience. This
                                track will allow participants without coding backgrounds to use their creativity to come
                                up with an idea and present it to a panel of judges.
                            </p>
                        </div>
                        <div className={`track learn ${this.state.toggle}`}>
                            <p>
                                The Learn track is for participants who do not have much experience in coding. This
                                track is an opportunity to add new skills to your toolbox and use them first-hand! The
                                Learn track will have in-depth workshops and code “starter kits” to provide participants
                                with the skills needed to build their project.
                                <br></br>
                                This year’s Learn track will teach <b>Web Development</b> and{' '}
